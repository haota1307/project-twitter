export const USERS_MESSAGES = {
  ...
  NAME_LENGTH_MUST_BE_FROM_6_TO_50: 'Name length must be from 6 to 50',
  ...
  NOT_YET_FOLLOWED_SOMEONE: 'Not yet followed someone',
  FOLLOWED: 'Followed',
  CANNOT_FOLLOW_ONESELF: 'Cannot follow oneself',
